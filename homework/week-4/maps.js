	...
	d3.json("GDP.json", function(error, data) {
    	...
    	data.forEach(function(d) {
    		...
    		colormaker = function(dollars){
    			if (dollars > 0 && dollars < 500000){
    				return "#bcbddc"}
    			else if (dollars > 500000 && dollars < 1000000){
    				return "#9e9ac8"}
    			else if (dollars > 1000000 && dollars < 1500000){
    				return "#807dba"}
    			else if (dollars > 1500000 && dollars < 2000000){
    				return "#807dba"}
    			else if (dollars > 2000000 && dollars < 2500000){
    				return "#6a51a3"}
    			else if (dollars > 2500000){
    				return "#54278f"}	
    		}
